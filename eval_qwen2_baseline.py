...
def main():
    ...
    batch_size = 32
    evaluate(model, processor, eval_dataset, batch_size=batch_size, out_dir="eval_results/baseline", split_name="valid")
    evaluate(model, processor, test_dataset, batch_size=batch_size, out_dir="eval_results/baseline", split_name="test")
